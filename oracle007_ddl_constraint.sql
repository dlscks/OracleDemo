...
datetime - 날짜 시간 저장
 ...
 CREATE TABLE student(
   ...
   age number(3), --자릿수
   avg number(5,2), --5는 전체자릿수, 2는 소숫점 자릿수
   hire date
   );
...
--2997.85 : 크기초과(5자리까지만 가능0 - 소수점은 포함하지 않는다.
--ORA-01438: value larger than specified precision allowed for this column
INSERT INTO student(name, age, avg, hire)
...
MODIFY name varchar2(30);
 ...
 --ORA-04043: sutdent 객체가 존재하지 않습니다.
 DESC sutdent;
...
--Table MEMBERS이(가) 삭제되었습니다.
DROP TABLE members;  -- AUTO COMMIT 발생
...
/*-----------------------------------------------------------
 무결성 제약조건
  ...
  무결성 제약조건 5종류 : not null, unique, primary key, foreign key, check
   ...
   unipue : 중복된 값을 허용하지 않는다. 항상 유일한 값이다.
